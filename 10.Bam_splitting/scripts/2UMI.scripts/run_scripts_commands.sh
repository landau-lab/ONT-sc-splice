...
#CH259 - Merging Genotype_2UMI cells
...
#CH305 - Merging Genotype_2UMI cells
...
#MDS_P5_1 - used Genotype_2UMI_mutUMIFrac0.2 
#sbatch merge_bams_MDS_P5_1_2UMI.sh /gpfs/commons/groups/landau_lab/SF3B1_splice_project/10.Bam_splitting/MDS_P5_1 /gpfs/commons/groups/landau_lab/SF3B1_splice_project/3.Genotyping_info/mds_p5_1.genotype.info.with.cell.type.txt

#MDS_P5_2 - used Genotype_2UMI_mutUMIFrac0.2 
#sbatch merge_bams_MDS_P5_2_2UMI.sh /gpfs/commons/groups/landau_lab/SF3B1_splice_project/10.Bam_splitting/MDS_P5_2 /gpfs/commons/groups/landau_lab/SF3B1_splice_project/3.Genotyping_info/mds_p5_2.genotype.info.with.cell.type.txt

#MDS_P6 - used Genotype_2UMI_mutUMIFrac0.2 
sbatch merge_bams_MDS_P6_2UMI.sh /gpfs/commons/groups/landau_lab/SF3B1_splice_project/10.Bam_splitting/MDS_P6 /gpfs/commons/groups/landau_lab/SF3B1_splice_project/3.Genotyping_info/mds_p6.genotype.info.with.cell.type.txt 
