...
## test data
# path.to.three.data = "/gpfs/commons/groups/landau_lab/SF3B1_splice_project/7.Permutation_junction_output/4.Comb_patients_merge_counts/MDS_P1_P2_P3/logOR_within_cell_type_ALT_3P_Junctions.txt"
# path.to.five.data = "/gpfs/commons/groups/landau_lab/SF3B1_splice_project/7.Permutation_junction_output/4.Comb_patients_merge_counts/MDS_P1_P2_P3/logOR_within_cell_type_ALT_5P_Junctions.txt"
