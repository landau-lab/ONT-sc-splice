...
junction.meta.file.path <- "/gpfs/commons/groups/landau_lab/SF3B1_splice_project/9.Splice_pipeline_example_run/MDS605/output_files/leafcutter_outputs/MDS605_output/MDS605_all.introns.info.w.primary.annotations.txt"

junction.count.file.path <- "/gpfs/commons/groups/landau_lab/SF3B1_splice_project/9.Splice_pipeline_example_run/MDS605/output_files/leafcutter_outputs/MDS605_output/MDS605_perind_numbers.counts.txt"

genotyping.table.file.path <- "/gpfs/commons/home/pchamely/SequencingData/MDS_dataset_06_06_21/MDS605.DIG.genotyping.txt"
...
write.table(junction.meta.sub, file="/gpfs/commons/groups/landau_lab/SF3B1_splice_project/13.Motif.Analysis/junction.matricies/MDS605.E662D.junction.info.w.mut.wt.cell.counts.full.txt", quote = T, sep=",",row.names = TRUE)
...
write.table(junction.meta.final, file="/gpfs/commons/groups/landau_lab/SF3B1_splice_project/13.Motif.Analysis/junction.matricies/MDS605.E662D.junction.info.w.mut.wt.cell.counts.txt", quote = F)
