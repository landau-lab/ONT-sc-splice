...
write.table(junction.meta.sub, file="/gpfs/commons/groups/landau_lab/SF3B1_splice_project/13.Motif.Analysis/junction.matricies/CH259.K666N.alt3p.junction.info.w.quantile.and.ct.counts.mutcells.only.full.txt", quote = T,row.names = TRUE, na = "NA",sep=",")
...
write.table(junction.meta.sub.final, file=paste0("/gpfs/commons/groups/landau_lab/SF3B1_splice_project/13.Motif.Analysis/junction.matricies/CH259.K666N.alt3p.junction.info.w.quantile.and.ct.counts.mutcells.only.txt"), quote = F)
