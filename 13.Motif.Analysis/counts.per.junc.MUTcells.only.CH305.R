...
junction.meta.file.path <- "/gpfs/commons/groups/landau_lab/SF3B1_splice_project/13.Motif.Analysis/junction.matricies/CH305.K700E.alt3p.junction.info.w.quantile.and.ct.counts.mutcells.only.txt"
...
write.table(junction.meta.sub, file="/gpfs/commons/groups/landau_lab/SF3B1_splice_project/13.Motif.Analysis/junction.matricies/CH305.K700E.alt3p.junction.info.w.quantile.and.ct.and.bulk.counts.mutcells.only.txt", quote = F)
